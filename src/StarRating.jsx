      ...
      <div style={containerStarStyle}>
        {Array.from({ length: max }, (_, i) => (
          <Star
            ...
            } /* ini mengecek kalau kita sedang hover maka dia akan merubah style tapi kalau tidak maka akan kembali ke setelan awal yang udh kita set utk handle rating jadi langsung ganti style ketika di klik * */
